  ...
  return (
    <div>
      <div className="relative" >
        <input className={`${inputExtCSS} bg-transparent w-[100%] h-[45px] xl:h-[55px] 2xl:h-[60px] md:w-[390px] md:h-[50px] border-[1px]  rounded-[19.5px] p-[14px] pt-[25px] `} type={inputType} />
