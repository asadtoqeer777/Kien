...
const Register = () => {
  return (
    <div className='bg-black h-[100%] p-5 sm:p-0'>
      <div className="container flex justify-center m-auto h-[100%] lg:h-[100vh]">
        <div className=' mb-[25px] 2xl:mb-[225px]'>
          ...
          <div className="mainImage text-center w-[310px] sm:w-[390px]  pt-[40px] m-auto relative  sm:pt-[50px] md:pt-[60px] lg:pt-[70px] xl:pt-[80px] 2xl:pt-[224px]">
            ...
            <div className="barImage">
              <div className='h-[540px] w-[35px] sm:h-[560px] md:h-[600px] lg:h-[640px] xl:h-[640px] 2xl:h-[779px] absolute top-0 right-[10px] sm:right-[35px] xl:right-[10px] z-10 bg-white'></div>
            </div>
          </div>
          <div className="mt-[46px] sm:mt-[56px] md:mt-[46px] lg:mt-[56px] xl:mt-[66px] 2xl:mt-[96px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-[50px]">
              ...
              <div>
                ...
                <div className="mt-3 text-right">
                  <Button btnClasses={"bg-[#E3FF00] w-[114px] h-[20px] rounded-[19.5px] text-[13px] font-medium"} btntext={"Register"} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-[30px] sm:mt-[30px] md:mt-[30px] lg:mt-[40px] xl:mt-[50px] 2xl:xl:mt-[180px] text-center">
            <Button btnClasses={"bg-transparent w-[114px] h-[20px] rounded-[19.5px] text-[13px] font-semibold	text-[#ffffff80]"} btntext={"Need Help?"} />
          </div>
